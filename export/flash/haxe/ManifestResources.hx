...
@:keep @:bind #if display private #end class __ASSET__assets_interface_greenbutton_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_interface_text_helveticarounded_bold_otf extends flash.text.Font { }
...
@:keep @:image("assets/interface/greenButton.png") #if display private #end class __ASSET__assets_interface_greenbutton_png extends lime.graphics.Image {}
