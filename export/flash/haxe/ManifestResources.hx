...
@:keep @:image("assets/cloudInfoRoom/images/item_statue_animated.png") #if display private #end class __ASSET__assets_cloudinforoom_images_item_statue_animated_png extends lime.graphics.Image {}
