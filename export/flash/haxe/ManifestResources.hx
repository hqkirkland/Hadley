...
@:keep @:bind #if display private #end class __ASSET__assets_images_interface_arialbitmap_size14px_fnt extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_interface_arialbitmap_size15 extends flash.utils.ByteArray { }
