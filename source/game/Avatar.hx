...
class Avatar extends FlxSprite
{
	...
	public var keysTriggered:AvatarKeys = {
		North: false,
		South: false,
		East: false,
		West: false,
	...
	public var previousKeysTriggered:AvatarKeys = {
		North: false,
		South: false,
		East: false,
		West: false,
	...
	public static var actionSet:Dynamic = {
		Stand: "Stand",
		Walk: "Walk",
		Sit: "Sit",
		Hold: "Hold"
	};
	public static var directionSet:Dynamic = {
		North: "North",
		South: "South",
		East: "East",
		West: "West"
